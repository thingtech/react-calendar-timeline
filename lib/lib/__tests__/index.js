...
var items = [{
  ...
  group: 1,
  title: 'item 1',
  start_time: (0, _moment2.default)('1995-12-25'),
  end_time: (0, _moment2.default)('1995-12-25').add(1, 'hour')
}, {
  id: 2,
  group: 2,
  title: 'item 2',
  start_time: (0, _moment2.default)('1995-12-25').add(-0.5, 'hour'),
  end_time: (0, _moment2.default)('1995-12-25').add(0.5, 'hour')
}, {
  id: 3,
  group: 3,
  title: 'item 3',
  start_time: (0, _moment2.default)('1995-12-25').add(2, 'hour'),
  end_time: (0, _moment2.default)('1995-12-25').add(3, 'hour')
}];

describe('Timeline', function () {
  it('shows grouping no matter of the group order', function () {
    var wrapper = (0, _enzyme.mount)(_react2.default.createElement(_Timeline2.default, {
      groups: groups,
      items: items,
  ...
  it('renders component with empty groups', function () {
    var allCorrect = true;
    try {
      (0, _enzyme.mount)(_react2.default.createElement(_Timeline2.default, {
        groups: [],
        items: items,
        defaultTimeStart: (0, _moment2.default)('1995-12-25').add(-12, 'hour'),
        defaultTimeEnd: (0, _moment2.default)('1995-12-25').add(12, 'hour')
